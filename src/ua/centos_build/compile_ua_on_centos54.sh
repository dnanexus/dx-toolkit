...
ifeq ($(UNAME), Linux)
  ...
  LDFLAGS := -static -pthread -L$(curl_dir)/lib -L$(boost_dir)/stage/lib -L$(ssl_dir)/lib -L$(cares_lib) -L/usr/lib -lcurl -lcares -lssl -lcrypto -lrt -lz -ldl -lboost_program_options -lboost_filesystem -lboost_system -lboost_thread -lboost_regex -lmagic
