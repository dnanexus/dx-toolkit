 ...
 */
dx::JSON findDataObjects(const dx::JSON &query);
 ...
 */
dx::JSON findOneDataObject(const dx::JSON &query);

//TODO: Documentation
dx::JSON findJobs(const dx::JSON &query);

//TODO: Documentation
dx::JSON findProjects(const dx::JSON &query);

//TODO: Documentation
dx::JSON findApps(const dx::JSON &query);
