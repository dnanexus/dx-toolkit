VIZPAYLOADERBUILDER_EXPECTED_OUTPUT = {
    "test_vizpayloadbuilder_location_cohort": {
        ...
        "expected_sql_output_1_1": [
            "SELECT `expression_1`.`feature_id` AS `feature_id`, `expression_1`.`sample_id` AS `sample_id`, `expression_1`.`value` AS `expression` FROM `database_j05kj2q06j8f5kkjbbpyvxky__molecular_expression_1_1`.`expression` AS `expression_1` LEFT OUTER JOIN `database_j05kj2q06j8f5kkjbbpyvxky__molecular_expression_1_1`.`expr_annotation` AS `expr_annotation_1` ON `expression_1`.`feature_id` = `expr_annotation_1`.`feature_id` WHERE `expr_annotation_1`.`CHROM` = '1' AND (`expr_annotation_1`.`end` BETWEEN 10000 AND 12000 OR `expr_annotation_1`.`start` BETWEEN 10000 AND 12000 OR `expr_annotation_1`.`end` >= 12000 AND `expr_annotation_1`.`start` <= 10000) ORDER BY `feature_id` ASC, `sample_id` ASC",
        ],
    },
    ...
    "test_vizpayloadbuilder_annotation_feature_name": {
        ...
        "expected_sql_output_1_1": "SELECT `expression_read_optimized_1`.`feature_id` AS `feature_id`, `expression_read_optimized_1`.`sample_id` AS `sample_id`, `expression_read_optimized_1`.`value` AS `expression` FROM `database_j05kj2q06j8f5kkjbbpyvxky__molecular_expression_1_1`.`expression_read_optimized` AS `expression_read_optimized_1` WHERE `expression_read_optimized_1`.`gene_name` IN ('ABL1') AND `expression_read_optimized_1`.`chr` = '9' AND `expression_read_optimized_1`.`bin` IN (52) ORDER BY `feature_id` ASC, `sample_id` ASC",
    },
