...
class TestDXExtractDataset(unittest.TestCase):
    ...
    def test_e2e_dataset_sql(self):
        ...
        self.assertTrue(truth_output_stage==stdout.strip() or truth_output_prod==stdout.strip())
    ...
    def test_e2e_cohortbrowser_sql(self):
        ...
        truth_output_prod = "SELECT `patient_0001_1`.`patient_id` AS `patient.patient_id`, `patient_0001_1`.`name` AS `patient.name`, `patient_0002_1`.`weight` AS `patient.weight`, `patient_0001_1`.`date_of_birth` AS `patient.date_of_birth`, `patient_0002_1`.`verified_dtm` AS `patient.verified_dtm`, `test_1`.`test_id` AS `test.test_id`, `trial_visit_0001_1`.`visit_id` AS `trial_visit.visit_id`, `baseline_0001_1`.`baseline_id` AS `baseline.baseline_id`, `hospital_0001_1`.`hospital_id` AS `hospital.hospital_id`, `doctor_0001_1`.`doctor_id` AS `doctor.doctor_id` FROM `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`patient_0001` AS `patient_0001_1` LEFT OUTER JOIN `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`patient_0002` AS `patient_0002_1` ON `patient_0001_1`.`patient_id` = `patient_0002_1`.`patient_id` LEFT OUTER JOIN `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`trial_visit_0001` AS `trial_visit_0001_1` ON `patient_0001_1`.`patient_id` = `trial_visit_0001_1`.`visit_patient_id` LEFT OUTER JOIN `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`test` AS `test_1` ON `trial_visit_0001_1`.`visit_id` = `test_1`.`test_visit_id` LEFT OUTER JOIN `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`baseline_0001` AS `baseline_0001_1` ON `patient_0001_1`.`patient_id` = `baseline_0001_1`.`b_patient_id` LEFT OUTER JOIN `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`hospital_0001` AS `hospital_0001_1` ON `patient_0001_1`.`hid` = `hospital_0001_1`.`hospital_id` LEFT OUTER JOIN `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`doctor_0001` AS `doctor_0001_1` ON `trial_visit_0001_1`.`visit_did` = `doctor_0001_1`.`doctor_id` WHERE `patient_0001_1`.`patient_id` IN (SELECT DISTINCT `patient_0001_1`.`patient_id` AS `patient_id` FROM `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`patient_0001` AS `patient_0001_1` WHERE `patient_0001_1`.`patient_id` IN (SELECT `patient_id` FROM (SELECT DISTINCT `cohort_subquery`.`patient_id` AS `patient_id` FROM (SELECT DISTINCT `patient_0001_1`.`patient_id` AS `patient_id`, `patient_0001_1`.`hid` AS `hid` FROM `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`patient_0001` AS `patient_0001_1` WHERE EXISTS (SELECT `hospital_0001_1`.`hospital_id` AS `hospital_id` FROM `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`hospital_0001` AS `hospital_0001_1` WHERE `hospital_0001_1`.`hospital_id` BETWEEN 2 AND 5 AND `hospital_0001_1`.`hospital_id` = `patient_0001_1`.`hid`)) AS `cohort_subquery` INTERSECT SELECT DISTINCT `patient_0001_1`.`patient_id` AS `patient_id` FROM `database_gf3gypj02kqg43784v3p8yqf__extract_dataset_test`.`patient_0001` AS `patient_0001_1` WHERE `patient_0001_1`.`patient_id` BETWEEN 2 AND 9)));"
