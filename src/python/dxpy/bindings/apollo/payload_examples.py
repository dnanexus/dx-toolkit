...
{
    """dx extract_assay expression record-Gz7VfJ009Y2fgkjpfVZFQB1J --retrieve-expression -j '{"location":[{"chromosome": "1","starting_position": "1","ending_position": "193723800"}]}' -o -""": {
...
{
    """dx extract_assay expression record-Gz7VfJ009Y2fgkjpfVZFQB1J --retrieve-expression -j '{"location":[{"chromosome": "1","starting_position": "1","ending_position": "193723800"}],"sample_id":["sample_1"]}' -o - --additional-fields strand""": {
        "project_context": "project-GyzGq4009Y2ZvJVy4qjBPbZB",
        "fields": [
            {"feature_id": "expression$feature_id"},
            {"sample_id": "expression$sample_id"},
...
{
    """ dx extract_assay expression record-Gz7VfJ009Y2fgkjpfVZFQB1J --retrieve-expression -j '{"annotation":{"feature_id": ["ENSG00000160180"]}}' -o - --additional-fields chrom """: {
        "project_context": "project-GyzGq4009Y2ZvJVy4qjBPbZB",
        "fields": [
