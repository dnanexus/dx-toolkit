...
def get_nextflow_assets(region):
    prod_assets = {
        ...
        "aws:us-east-1": ("record-GJQX84Q0xggPb6xzFv918Z90", "record-GGbKvfQ0Yy4JPBbP4vfF5P3z"),
    ...
    stg_assets = {
        ...
        "aws:us-east-1": ("record-GJQPPpQ0KXZb19gfFxFg8zZk", "record-GG23y1j00vk1BJ5zKzykGXvY"),
