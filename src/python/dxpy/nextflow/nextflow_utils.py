...
def get_nextflow_assets(region):
    prod_assets = {
        ...
        "aws:us-east-1": ("record-GJk3yb00z0QPXg134fJG6ZQ2", "record-GGbKvfQ0Yy4JPBbP4vfF5P3z"),
    ...
    stg_assets = {
        ...
        "aws:us-east-1": ("record-GJk3yb00z0QPXg134fJG6ZQ2", "record-GG23y1j00vk1BJ5zKzykGXvY"),
