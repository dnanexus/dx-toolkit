...
main() {
    ...
    @@RUN_INPUTS@@
    nextflow -trace nextflow.plugin $nf_run_args_and_pipeline_params -log ${LOG_NAME} run /home/dnanexus/nfp @@PROFILE_ARG@@ -name $test-{NXF_UUID} $nf_run_args_and_pipeline_params ${filtered_inputs}
}
