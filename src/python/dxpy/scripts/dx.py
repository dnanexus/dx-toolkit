...
def find_apps(args):
    ...
    try:
        ...
        if args.brief:
            ...
            for result in results:
                print maybe_x(result) + DELIMITER(" ") + result["id"] + DELIMITER(" ") + result['describe'].get('title', result['describe']['name']) + DELIMITER(' (') + result["describe"]["name"] + DELIMITER('), v') + result['describe']['version'] + DELIMITER(" (") + ("published" if result["describe"]["published"] > 0 else "unpublished") + DELIMITER(")")
    except BaseException as details:
        parser.exit(1, fill(unicode(details)) + '\n')
...
def upgrade(args):
    if len(args.args) == 0:
        try:
            ...
            version_match = re.match("A recommended update is available for your client/SDK \(v(.+?)\)", upgrade_header)
            if version_match:
...
def print_help(args):
    if args.command_or_category is None:
        ...
        if args.subcommand is None:
            parser_map[args.command_or_category][0].print_help()
        else:
        ...
        parser_map[args.command_or_category + ' ' + args.subcommand][0].print_help()
...
parser_map['login'] = (parser_login, NoneCompleter())
...
parser_map['logout'] = (parser_logout, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['session']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['sh'] = (parser_shell, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['session']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['exit'] = (parser_exit, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['session']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['env'] = (parser_env, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['session']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['setenv'] = (parser_setenv, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['clearenv'] = (parser_clearenv, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['session']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['invite'] = (parser_invite, NoneCompleter()) # TODO
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['other']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['uninvite'] = (parser_uninvite, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['other']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['ls'] = (parser_ls, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['tree'] = (parser_tree, DXPathCompleter(expected='folder'))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['pwd'] = (parser_pwd, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_select = subparsers.add_parser('select', help='List and select a project to switch to',
                                      ...
                                      prog='dx select',
                                      parents=[env_args])
parser_select.add_argument('project', help='Name or ID of a project to switch to; if not provided a list will be provided for you', nargs='?', default=None)
...
parser_map['select'] = (parser_select, DXPathCompleter(expected='project', include_current_proj=False))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['cd'] = (parser_cd, DXPathCompleter(expected='folder'))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['cp'] = (parser_cp, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['mv'] = (parser_mv, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['mkdir'] = (parser_mkdir, DXPathCompleter(expected='folder'))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['rmdir'] = (parser_rmdir, DXPathCompleter(expected='folder'))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['rm'] = (parser_rm, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['describe'] = (parser_describe, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_upload = subparsers.add_parser('upload', help='Upload a file or directory',
                                      ...
                                      prog="dx upload")
parser_upload.add_argument('filename', help='Local file or directory to upload ("-" indicates stdin input)')
...
parser_map['upload'] = (parser_upload, LocalCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['data']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['download'] = (parser_download, DXPathCompleter(classes=['file']))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['data']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['cat'] = (parser_cat, DXPathCompleter(classes=['file']))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['data']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['head'] = (parser_head, DXPathCompleter(classes=['file', 'gtable']))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['data']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['import'] = (parser_import, LocalCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['data']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['export'] = (parser_export, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['data']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['build'] = (parser_build, LocalCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['install'] = (parser_install, DXAppCompleter(installed=False))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['exec']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['uninstall'] = (parser_uninstall, DXAppCompleter(installed=True))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['exec']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_run.add_argument('executable', help=fill('Name or ID of an applet, app, or workflow to run; must be provided if --clone is not set', width_adjustment=-24), nargs="?", default="")
...
parser_map['run'] = (parser_run, MultiCompleter([DXAppCompleter(), DXPathCompleter(classes=['applet']), DXPathCompleter(classes=['record'], typespec='pipeline')]))
parser_categories['all']['cmds'].append(('run', 'Run an applet, app, or workflow'))
parser_categories['exec']['cmds'].append(('run', 'Run an applet, app, or workflow'))
...
parser_map['watch'] = (parser_watch, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['exec']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['terminate'] = (parser_terminate, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['exec']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['new'] = (parser_new, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['data']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['new project'] = (parser_new_project, NoneCompleter())
parser_categories['fs']['cmds'].append(('new project', subparsers_new._choices_actions[-1].help))
...
parser_map['rmproject'] = (parser_rmproject, DXPathCompleter(expected='project', include_current_proj=True))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['fs']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['new record'] = (parser_new_record, DXPathCompleter(classes=['record']))
...
parser_map['new gtable'] = (parser_new_gtable, DXPathCompleter(classes=['gtable']))
...
parser_map['get_details'] = (parser_get_details, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['set_details'] = (parser_set_details, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['set_visibility'] = (parser_set_visibility, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['add_types'] = (parser_add_types, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['remove_types'] = (parser_remove_types, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['tag'] = (parser_tag, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['untag'] = (parser_untag, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['rename'] = (parser_rename, DXPathCompleter(include_current_proj=True))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['set_properties'] = (parser_set_properties, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['unset_properties'] = (parser_unset_properties, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_wait = subparsers.add_parser('wait', help='Wait for data object(s) to close or job(s) to finish', description='Polls the state of specified data object(s) or job(s) until they are all in the desired state.  Waits until the "closed" state for a data object, and for any terminal state for a job ("terminated", "failed", or "done").  Exits with a non-zero code if a job reaches a terminal state that is not "done".',
                                    prog='dx wait',
                                    parents=[env_args])
parser_wait.add_argument('path', help='Path to a data object or job ID to wait for', nargs='+')
parser_wait.set_defaults(func=wait)
parser_map['wait'] = (parser_wait, DXPathCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['data']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['metadata']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['exec']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['get'] = (parser_get, DXPathCompleter(classes=['file', 'record', 'applet']))
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['data']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['find'] = (parser_find, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['find apps'] = (parser_find_apps, NoneCompleter())
...
parser_map['find jobs'] = (parser_find_jobs, DXPathCompleter(expected='project'))
...
parser_map['find data'] = (parser_find_data, DXPathCompleter(expected='folder'))
...
parser_map['find projects'] = (parser_find_projects, NoneCompleter())
...
parser_map['api'] = (parser_api, NoneCompleter())
parser_categories['all']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
parser_categories['other']['cmds'].append((subparsers._choices_actions[-1].dest, subparsers._choices_actions[-1].help))
...
parser_map['help'] = (parser_help, NoneCompleter()) # TODO: a special help completer
parser_map['help run'] = (parser_help, MultiCompleter([DXAppCompleter(), DXPathCompleter(classes=['applet']), DXPathCompleter(classes=['record'], typespec='pipeline')]))
