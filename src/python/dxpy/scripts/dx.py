...
parser_cp.add_argument('--target-file-relocation', help='Flag to allow symlink target file relocation in external storage while cloning a symlink.', default=False)
