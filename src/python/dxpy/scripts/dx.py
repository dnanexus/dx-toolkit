...
def archive(args):
    ...
    if args.confirm and INTERACTIVE_CLI:
        ...
        if mode == "archival":
            counts = len(target_files) or len(list(dxpy.find_data_objects(project=target_project,folder=target_folder,classname="file",recurse=args.recurse)))
