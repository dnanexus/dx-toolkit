...
[
  ...
  [
    ...
    "fileNew(req)",
    {
      "objectMethod": false,
      "retryable": false,
      "docsLink": "https://wiki.dnanexus.com/API-Specification-v1.0.0/Files#API-method%3A-%2Ffile%2Fnew",
      "acceptsNonce": true
    }
  ],
  ...,
...
3. The third element is a hash with the following fields:
    ...
    * `docsLink`: either null or a string; if provided, contains a URL for documentation for the route. This information can be used to add documentation links in api wrapper documentation.
