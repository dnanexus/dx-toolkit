...
public class IdempotencyTest {
    ...
    public void testIdempotentFileCreation() {
        JsonNode input = DXJSON.getObjectBuilder().put("name", "test_file")
                                                  .put("project", testProject.getId())
                                                  .put("nonce", Nonce.nonce()).build();
    ...
    public void testIdempotentAppletCreation() {
        JsonNode input = DXJSON.getObjectBuilder().put("name", "test_applet")
                                .put("project", testProject.getId())
                                .put("inputSpec", DXJSON.getArrayBuilder().build())
                                .put("runSpec", DXJSON.getObjectBuilder()
    ...
    public void testIdempotentAppletRun() {
        JsonNode inputSpec = DXJSON.getArrayBuilder().add(
                             DXJSON.getObjectBuilder().put("name", "s").put("class", "string").build())
                             .build();
        ...
        JsonNode input = DXJSON.getObjectBuilder().put("name", "test_applet")
                                ...
                                .put("runSpec", DXJSON.getObjectBuilder()
                                    .put("interpreter", "bash")
                                    .put("code", "#!/bin/bash\n\necho hello world!").build())
                                .put("dxapi", "1.0.0").build();

        JsonNode applet = DXAPI.appletNew(input, JsonNode.class);

        JsonNode appletRunInput = DXJSON.getObjectBuilder()
                                .put("project", testProject.getId())
                                .put("input", DXJSON.getObjectBuilder().put("s", "param").build())
                                .put("nonce", Nonce.nonce()).build();
    ...
    public void testIdempotentAppCreation() {
        ...
        JsonNode input = DXJSON.getObjectBuilder().put("name", "test_applet")
                                ...
                                .put("runSpec", DXJSON.getObjectBuilder()
                                    .put("interpreter", "bash")
                                    .put("code", "#!/bin/bash\n\necho hello world!").build())
                                .put("outputSpec", DXJSON.getArrayBuilder().build())
                                .put("dxapi", "1.0.0").build();
        ...
        // Test appRun
        JsonNode appRunInput = DXJSON.getObjectBuilder()
                                .put("project", testProject.getId())
                                .put("input", DXJSON.getObjectBuilder().put("s", "param").build())
                                .put("nonce", Nonce.nonce()).build();
    ...
    public void testIdempotentOrgCreation() {
        ...
        JsonNode input = DXJSON.getObjectBuilder().put("name", "test_org")
                                .put("handle", "org_handle")
                                .put("nonce", Nonce.nonce()).build();
    ...
    public void testIdempotentWorkflowCreation() {
        JsonNode input = DXJSON.getObjectBuilder().put("name", "test_workflow")
                                .put("project", testProject.getId())
                                .put("nonce", Nonce.nonce()).build();
