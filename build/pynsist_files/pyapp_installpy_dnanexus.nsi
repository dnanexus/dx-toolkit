...
; https://github.com/takluyver/pynsist/blob/master/nsist/pyapp_installpy.nsi

[% extends "pyapp_dnanexus.nsi" %]
...
Section "Python ${PY_VERSION}" sec_py
  ...
  [% else %]
    ...
    ; Allow Python to choose the default install dir (C:\Python27)
    ExecWait 'msiexec /i "$INSTDIR\[[filename]]" /qb ALLUSERS=1'
  [% endif %]
