...
PYENVS = \
    ["system"] + \
    [f"official-{p}" for p in ("3.8", "3.9", "3.10", "3.11", "3.12", "3.13", "3.14")] + \
    [f"pyenv-{p}" for p in ("3.8", "3.9", "3.10", "3.11", "3.12", "3.13", "3.14")] + \
    [f"brew-{p}" for p in ("3.8", "3.9", "3.10", "3.11", "3.12", "3.13", "3.14")]
