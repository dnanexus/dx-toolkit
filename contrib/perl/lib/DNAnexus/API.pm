...
sub databaseNew(;$%) {
    my ($input_params, %kwargs) = @_;
    %kwargs = () unless %kwargs;
    return DXHTTPRequest('/database/new', $input_params, %kwargs);
}


sub databasetypeNewSpot(;$%) {
    my ($input_params, %kwargs) = @_;
    %kwargs = () unless %kwargs;
