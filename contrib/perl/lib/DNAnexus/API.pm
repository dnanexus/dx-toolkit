...
sub systemBulkCloneRenameAndTag(;$%) {
    my ($input_params, %kwargs) = @_;
    %kwargs = () unless %kwargs;
    return DXHTTPRequest('/system/bulkCloneRenameAndTag', $input_params, %kwargs);
}
