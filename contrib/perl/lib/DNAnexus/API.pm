...
sub databaseFindByName(;$%) {
    my ($input_params, %kwargs) = @_;
    %kwargs = () unless %kwargs;
    return DXHTTPRequest('/database/findByName', $input_params, %kwargs);
}
