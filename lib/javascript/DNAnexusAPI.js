...
exports.appAddCategories = function(object_id, input_params) {
  return dx.DXHTTPRequest('/' + object_id + '/addCategories', input_params);
};


exports.appAddTags = function(object_id, input_params) {
  return dx.DXHTTPRequest('/' + object_id + '/addTags', input_params);
};


exports.appDelete = function(object_id, input_params) {
...
exports.appGet = function(object_id, input_params) {
  return dx.DXHTTPRequest('/' + object_id + '/get', input_params);
};


exports.appInstall = function(object_id, input_params) {
  return dx.DXHTTPRequest('/' + object_id + '/install', input_params);
};


exports.appListCategories = function(object_id, input_params) {
  return dx.DXHTTPRequest('/' + object_id + '/listCategories', input_params);
};


exports.appPublish = function(object_id, input_params) {
  return dx.DXHTTPRequest('/' + object_id + '/publish', input_params);
};


exports.appRemoveCategories = function(object_id, input_params) {
  return dx.DXHTTPRequest('/' + object_id + '/removeCategories', input_params);
};


exports.appRemoveTag = function(object_id, input_params) {
  return dx.DXHTTPRequest('/' + object_id + '/removeTag', input_params);
};


exports.appRemoveTags = function(object_id, input_params) {
...
exports.appUninstall = function(object_id, input_params) {
  return dx.DXHTTPRequest('/' + object_id + '/uninstall', input_params);
};


exports.appUpdate = function(object_id, input_params) {
